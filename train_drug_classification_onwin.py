...
# Load the dataset
data_csv_file = "C:\\Users\\nisar\\cs\ml3\\frag_ml\\drug_classification_data_df.csv"
data_org = pd.read_csv(data_csv_file, nrows=50)

data_map = read_csv(data_csv_file)
mapping_x = data_map["mapping"]["x"]
mapping_y = data_map["mapping"]["y"]
...
joblib.dump(config, "C:\\Users\\nisar\\cs\ml3\\frag_ml\\config.pkl")
